...
const ui = {
  ...
  mbtiTab: { ko: "MBTI 연결", en: "MBTI Link" },
  ...
  // Type Detail Page - New Sections
  typeDetailDeepSummary: { ko: "심층 분석", en: "Deep Dive" },
  typeDetailHumorPhilosophy: { ko: "유머 철학", en: "Humor Philosophy" },
  typeDetailSignatureTechniques: { ko: "대표 기법", en: "Signature Techniques" },
  typeDetailSocialDynamics: { ko: "사회적 역학", en: "Social Dynamics" },
  typeDetailInGroups: { ko: "그룹에서", en: "In Groups" },
  typeDetailOneOnOne: { ko: "1:1 대화에서", en: "One-on-One" },
  typeDetailAsAudience: { ko: "청중으로서", en: "As Audience" },
  typeDetailGrowthTips: { ko: "성장 팁", en: "Growth Tips" },
  typeDetailMBTICorrelations: { ko: "MBTI 상호작용", en: "MBTI Interactions" },
  typeDetailMBTIMatrix: { ko: "MBTI-유머 매트릭스", en: "MBTI-Humor Matrix" },
  typeDetailMatrixDesc: { ko: "유머 스타일과 MBTI 성격 유형의 상호작용을 알아보세요", en: "Discover how humor styles interact with MBTI personality types" },
  typeDetailExpression: { ko: "표현 방식", en: "Expression" },
  typeDetailReception: { ko: "반응 패턴", en: "Reception" },
  typeDetailWhenFails: { ko: "개그 실패 시", en: "When Jokes Fail" },
  typeDetailHighCompat: { ko: "높은 시너지", en: "High Synergy" },
  typeDetailMediumCompat: { ko: "보통", en: "Medium" },
  typeDetailLowCompat: { ko: "낮은 시너지", en: "Low Synergy" },
  typeDetailNeutralCompat: { ko: "중립", en: "Neutral" },
  typeDetailClickForDetails: { ko: "셀을 클릭하면 상세 정보를 볼 수 있어요", en: "Click any cell for details" },
  typeDetailYourType: { ko: "당신의 유형", en: "Your Type" },
  typeDetailMBTITypes: { ko: "MBTI 유형별 표현", en: "Expression by MBTI Type" },
  typeDetailSelectMBTI: { ko: "MBTI 유형 선택", en: "Select MBTI Type" },
  typeDetailWhenThisType: { ko: "이 유형이라면", en: "As This Type" },
  typeDetailHumorExpression: { ko: "유머 표현 방식", en: "Humor Expression" },

  // MBTI Axis Labels
  mbtiAxisEI: { ko: "외향(E) / 내향(I)", en: "Extraversion (E) / Introversion (I)" },
  mbtiAxisNS: { ko: "직관(N) / 감각(S)", en: "Intuition (N) / Sensing (S)" },
  mbtiAxisTF: { ko: "사고(T) / 감정(F)", en: "Thinking (T) / Feeling (F)" },
  mbtiAxisJP: { ko: "판단(J) / 인식(P)", en: "Judging (J) / Perceiving (P)" },
  mbtiAxisEIDesc: { ko: "표현 스타일", en: "Expression Style" },
  mbtiAxisNSDesc: { ko: "접근 방식", en: "Approach" },
  mbtiAxisTFDesc: { ko: "수용 및 회복", en: "Reception & Recovery" },
  mbtiAxisJPDesc: { ko: "상황 대처", en: "Situation Handling" },
} as const;
