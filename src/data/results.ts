...
export const gagResults: Record<string, GagResult> = {
  ...
  OBVB: {
    code: "OBVB",
    nickname: "꽁트 장인",
    summary: "비언어적이고 준비된 스타일을 바탕으로, 치밀하게 기획된 병맛 세계관을 설정하고 그 안에서 개그를 전개합니다. 이 유형은 구조, 흐름, 캐릭터 설정까지 '개그의 드라마화'를 꾀하며, 병맛조차 논리적으로 짜여 있습니다. 설정 자체가 유머이며, 시청자는 그 구조의 정교함과 설정 간의 대비 속에서 웃음을 느낍니다. 몰입 유도력이 뛰어나며, 상황극을 활용한 고급 병맛 유머의 대표 유형입니다.",
  ...
  IBVB: {
    code: "IBVB",
    nickname: "천진난만 꽃밭",
    summary: "즉흥적, 비언어적이며 밝은 감정 톤을 가진 이들은, 진지한 상황에 갑작스럽게 병맛 리액션을 던짐으로써 상황을 무너뜨리는 능력을 갖췄습니다. 타이밍 감각이 뛰어나며, 병맛이란 무엇인가에 대한 직관적 이해가 있습니다. 논리보다 충격, 구성보다 타이밍이 중요한 구조에서 유머가 생성됩니다. 병맛의 '불쑥 등장'을 무기로 삼는 무대형 리액션 유머입니다.",
