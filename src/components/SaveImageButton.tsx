...
export default function SaveImageButton({ targetRef, fileName = "my-gag-code" }: SaveImageButtonProps) {
  ...
  return (
    <button
      onClick={handleSave}
      disabled={saving}
      className="group bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 disabled:from-gray-400 disabled:to-gray-500 text-white rounded-xl px-6 py-3 text-sm font-medium transition-all duration-300 transform hover:scale-105 disabled:scale-100 shadow-lg flex items-center justify-center gap-2"
    >
      {saving ? (
        <>
